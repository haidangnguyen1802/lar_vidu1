...
<head>
    ...
    <style>
        body {
            background: url('storage/images/bgtan.jpg') no-repeat center center fixed;
        ...
        .card {
            background: rgba(0, 0, 0, 0.8); /* Màu đen với độ trong suốt */
            padding: 40px;
            ...
            color: white; /* Màu chữ trắng để nổi bật trên nền đen */
        }

        .card-header {
            background-color: transparent;
            color: #fff; /* Màu chữ trong tiêu đề */
            text-align: center;
            padding: 0.7rem;
            border-bottom: none;
            border: 2px solid #fff; /* Khung in đậm cho tiêu đề */
            border-radius: 0.5rem; /* Đường viền bo góc */
        }
        ...
        .form-control {
            ...
            background: rgba(255, 255, 255, 0.2); /* Nền ô nhập liệu trong suốt */
        ...
        .form-control::placeholder {
            ...
            opacity: 1; /* Đảm bảo màu luôn hiển thị */
        }
        ...
        .register-link {
            color: #fff; /* Màu chữ của liên kết đăng ký */
                        ...
                        <form method="POST" action="{{ url('login') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="email" type="email" name="email" class="form-control" value="{{ old('email') }}" required placeholder="Nhập email của bạn">
                                </div>
                                @error('email')
                            ...
                            <div class="form-group password-wrapper">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="password" type="password" name="password" class="form-control" required placeholder="Nhập mật khẩu của bạn">
