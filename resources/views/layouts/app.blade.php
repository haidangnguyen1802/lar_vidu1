                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown">
                        <a class="nav-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="{{ asset('storage/images/TK4.png') }}" alt="Tài khoản" style="width: 50px; height: 50px;">
                            <span class="ms-2" style="font-size: 20px;">Tài khoản</span>
                        </a>
                        ...
                        @if(auth()->check())
                                <li>
                                    <a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="font-size: 20px;">
                                        <img src="{{ asset('storage/images/IconLG.png') }}" alt="Logout" style="width: 35px; height: 30px; margin-right: 5px;">
                                        Logout
                                    </a>
                                </li>
                            @else
                                <li>
                                    <a class="dropdown-item" href="{{ route('login') }}">
                                        <img src="{{ asset('storage/images/LG6.png') }}" alt="Login" style="width: 40px; height: 40px; margin-right: 8px;">
                                        Đăng nhập
                                    </a>
                                </li>
                            @endif
                    ...
                    <div class="cart-icon ms-3 d-flex align-items-center">
                        <a class="nav-link d-flex align-items-center" href="{{ route('cart.index') }}">
                            <div style="position: relative;">
                                <img src="{{ asset('storage/images/giohang.jpg') }}" alt="Giỏ Hàng" style="width: 55px; height: 55px;">
